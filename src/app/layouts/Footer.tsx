      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold mb-4 text-texto-fondo-oscuro">
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 rounded-full hover:opacity-80 transition-opacity text-enlaces-textos-interactivos" style={{ backgroundColor: colorsWithOpacity.textoFondoOscuro10 }}>
