...
export default function Carousel() {
  ...
  // Diapositivas sin depender de imágenes locales
  const slides = [
    {
      title: 'Bienvenido a Miru Franco',
      subtitle:
        'A solo minutos encuentras productos de calidad profesional. Descubre la magia del cuidado capilar con experiencias auténticas y personalizadas.',
    },
    {
      title: 'Productos Premium',
      subtitle:
        'Líneas especializadas para cada tipo de cabello. Ingredientes naturales que nutren y protegen tu melena.',
    },
    {
      title: 'Servicios Profesionales',
      subtitle:
        'Equipo experto dedicado a realzar tu belleza. Transformamos tu look con técnicas modernas y tradicionales.',
    },
  ];
        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="absolute inset-0 z-10 flex items-center justify-center px-4">
              ...
              >
                <h2
                  className="text-elegant-display mb-4 uppercase"
