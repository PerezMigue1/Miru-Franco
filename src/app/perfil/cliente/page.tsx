              ...
              <Card>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between p-3 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <span className="text-sm" style={{ color: colors.encabezadosAlterno }}>Servicios Totales</span>
                    <span className="text-sm font-semibold" style={{ color: colors.menuTextoPrincipal }}>8</span>
                  </div>
                  <div className="flex justify-between p-3 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <span className="text-sm" style={{ color: colors.encabezadosAlterno }}>Cliente desde</span>
                    <span className="text-sm font-semibold" style={{ color: colors.menuTextoPrincipal }}>2023</span>
                  </div>
                  <div className="flex justify-between p-3 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <span className="text-sm" style={{ color: colors.encabezadosAlterno }}>Estado</span>
