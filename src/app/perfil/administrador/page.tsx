        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <Badge variant="info" size="lg">Administrador</Badge>
            </div>
              ...
              <Card>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {['Inventario', 'Usuarios', 'Reportes', 'Ventas', 'Citas', 'Facturación', 'Personal', 'Proveedores', 'Marketing'].map((modulo) => (
                      <div key={modulo} className="p-3 rounded-lg text-center" style={{ backgroundColor: colors.fondosSuaves }}>
                        <Badge variant="success" size="sm">{modulo}</Badge>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <Card>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <p className="text-2xl font-bold mb-1" style={{ color: colors.menuTextoPrincipal }}>$45,000</p>
                    <p className="text-sm" style={{ color: colors.encabezadosAlterno }}>Ventas</p>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <p className="text-2xl font-bold mb-1" style={{ color: colors.menuTextoPrincipal }}>120</p>
                    <p className="text-sm" style={{ color: colors.encabezadosAlterno }}>Servicios</p>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                  ...
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: colors.fondosSuaves }}>
                    <p className="text-2xl font-bold mb-1" style={{ color: colors.menuTextoPrincipal }}>85</p>
                    <p className="text-sm" style={{ color: colors.encabezadosAlterno }}>Productos Vendidos</p>
                  </div>
                </div>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              <Card>
                <div className="text-center mb-4">
                  ...
                  <Button size="sm" variant="outline" fullWidth>Cambiar Foto</Button>
                </div>
              </Card>
              ...
              <Card>
                ...
                <div className="space-y-2">
                  <Button variant="outline" fullWidth>Gestionar Usuarios</Button>
                  <Button variant="outline" fullWidth>Ver Reportes</Button>
                  <Button variant="outline" fullWidth>Configuración del Sistema</Button>
                  <Button variant="outline" fullWidth>Backup y Respaldo</Button>
                </div>
              </Card>
